...
\newcommand{\Specialcell}[2][X]{\begin{tabular}[#1]{@{}l@{}}#2\end{tabular}}
...
\newcommand{\user}[0]{\textit{user}}
\newcommand{\cmd}[0]{\textit{cmd}}
\newcommand{\port}[0]{\textit{port}}
\newcommand{\host}[0]{\textit{host}}
\newcommand{\pid}[0]{\textit{pid}}
\newcommand{\str}[0]{\textit{str}}

\newcounter{tipcounter}
\newcommand{\tipitem}[2]{\begin{minipage}{\columnwidth}\stepcounter{tipcounter}\arabic{tipcounter} \textbf{#1}\\#2\end{minipage}\vspace{0.6em}}
