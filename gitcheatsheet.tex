...
\mytable{gX}{
	\important{\code{cmd}}	&	Important for beginners	\\
...
\mytable{iX}{
	...
	updating the master branch with changes from a feature branch before deleting it
	\\
}
...
\\
\vspace{1em}
Delete any copy or reference of a file on the current branch:
\mytable{a}{
